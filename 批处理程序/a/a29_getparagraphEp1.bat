...
set endline=:endline
call a\a29_getparagraph.bat "a\a29_getparagraphEp1.bat" startline endline test
echo,总行数：%test.list[]%
for /l %%i in (1,1,%test.list[]%) do (
	call :show %%i
)
pause
exit
:show
call a\a20_varcopy.bat test.list[%1].truevalue show
echo,%show.showvalue%
goto :eof
