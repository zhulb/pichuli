...
echo,&echo,---------------------------输入命令：
echo,[例]zjodps/zjodps@orcl
rem set /p commend=
set commend=zjodps/zjodps@orcl
cls
...
>D20_临时文件夹\D20_删除所有表sql.sql echo,conn zjodps/zjodps;
...
conn zjodps/zjodps;
spool 
select 'drop table '||table_name||';' from all_tables where owner='zjodps';
spool off;
exit;
::删除所有表sql end
cls
